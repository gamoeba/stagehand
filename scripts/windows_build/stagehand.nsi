...
; This script is based on example1.nsi, but it remember the directory, 
	...
	; The file to write
	OutFile "output\Stagehand_$%VERSION%.exe"
	...
	VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductName" "Stagehand"
	VIAddVersionKey /LANG=${LANG_ENGLISH} "CompanyName" "Gamoeba"
	VIAddVersionKey /LANG=${LANG_ENGLISH} "FileDescription" "Dali Visual Debugger"
	VIAddVersionKey /LANG=${LANG_ENGLISH} "LegalCopyright" "Gamoeba Ltd"
	...
	CreateShortCut "$SMPROGRAMS\Stagehand\Stagehand.lnk" "$INSTDIR\stagehand.bat" "" "$INSTDIR\stagehand.ico" 0 SW_SHOWMINIMIZED
